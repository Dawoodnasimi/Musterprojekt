...
const my_data = [...props.posts.data]; // Eine Kopie der Daten erstellen
...
const search = () => {
    if (searchTerm.value.length > 0) {
        ...
        props.posts.data = my_data.filter((post) => {
            return (
                post.title
                    .toLowerCase()
        ...
        console.log("searchTerm.value is empty or null");
        props.posts.data = [...my_data]; // Ursprüngliche Daten wiederherstellen
    }
};
