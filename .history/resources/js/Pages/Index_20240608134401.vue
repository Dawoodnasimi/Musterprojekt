  ...
  <div class="flex items-center justify-center pb-4">
    <div v-for="post in posts.links" :key="post.url" class="flex">
      <Link
        ...
        :href="post.url"
        as="button"
        class="mx-1 px-3 py-2 rounded-md text-sm font-medium text-white bg-blue-700 disabled:opacity-50"
        v-html="post.label"
      ></Link>
      <Link
        v-else
        :href="post.url"
        as="button"
        class="mx-1 px-3 py-2 rounded-md text-sm font-medium text-gray-700 bg-gray-200"
        v-html="post.label"
      ></Link>
    </div>
  </div>
