...
<template>
    ...
    <div class="flex items-center justify-center min-h-screen pt-4 bg-gray-200">
        <div class="w-full max-w-md">
            ...
            >
                <h1 class="title text-center mb-4 font-bold text-xl">
                    Create Post
                </h1>
                ...
                <div class="mb-6">
                    ...
                    <textarea
                        ...
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:border-blue-500 outline-none border-gray-500"
                        rows="5"
                        placeholder="Content"
                    ></textarea>
                    <small
                        class="error text-red-500"
                        v-if="!form.content && submitted"
