...
const data_intact = ref(props.posts.data);
const value = data_intact.value;

console.log("data_intact: " + data_intact.value);
console.log("value: " + value);
console.log("my_data: " + my_data.value);
