...
<template>
    ...
    <div v-else>
        ...
        >
            <div class="flex-grow relative w-40">
                <input
                    type="text"
                    v-model="searchTerm"
                    @input="search"
                    placeholder="Search..."
                    class="shadow-lg appearance-none border rounded-md w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                />
            </div>
