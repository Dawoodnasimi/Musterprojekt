          ...
          >
            ...
            >
              ...
              <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                ...
                <Link
                  class="bg-red-500 text-white mt-2 mx-1 px-3 py-2 rounded-md text-sm font-medium hover:bg-red-600 ml-2"
                ...
                <button
                  type="button"
                  class="bg-white-200 text-black mt-2 mx-1 px-3 py-2 rounded-md text-sm font-medium hover:bg-gray-300 border border-gray-300"
                  @click="showConfirmation = false"
                >
                  Cancel
                </button>
