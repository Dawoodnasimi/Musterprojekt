...
/* const hasPrevious = computed(() => {
  return props.posts.links.some((link) => link.label === "Previous" && link.url !== null);
});

const hasNext = computed(() => {
  return props.posts.links.some((link) => link.label === "Next" && link.url !== null);
});

const previousPageUrl = computed(() => {
  const previousLink = props.posts.links.find((link) => link.label === "Previous");
  return previousLink ? previousLink.url : null;
});

const nextPageUrl = computed(() => {
  const nextLink = props.posts.links.find((link) => link.label === "Next");
