...
<template>
  ...
  <div
    class="container mx-auto p-5 w-full flex justify-center items-center"
    v-for="post in posts.links"
  >
    <Link class="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600"
    :href="post.url" as="button" v-text="post.label"
  </div>
</template>
