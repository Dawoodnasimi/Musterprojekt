...
const handleDeleteClick = () => {
    ...
    if (this.posts.data.length === 0 && this.currentPage > 1) {
        // If it is, decrement the current page number
        this.currentPage--;
    }

    methods: {
    handleDeleteClick(postId) {
        this.$inertia.delete(`posts/delete/${postId}`);
    }
};
            ...
            >
              ...
              >
                <Link
                  ...
                  method="DELETE"
                  as="button"
                  @click.prevent="handleDeleteClick(post.id)"
                >
                  Delete Post
                </Link>
                <button
