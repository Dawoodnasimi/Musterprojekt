  ...
  <div class="flex items-center justify-center pb-4">
    <div v-for="post in posts.links" :key="post.url" class="flex">
      <Link
        ...
        :href="post.url"
        as="button"
        class="mx-1 px-3 py-2 rounded-md text-sm font-medium text-white bg-blue-700"
      >
        {{ post.label }}
        :href="post.url" as="button" class="mx-1 px-3 py-2 rounded-md text-sm font-medium
        text-blue-700 bg-blue-100 hover:bg-blue-200" v-html="post.label" ></Link
      >
    </div>
  </div>
</template>
