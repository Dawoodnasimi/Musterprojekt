...
const toast = reactive({ message: null, type: null });
...
const handleDeleteClick = (posts) => {
  ...
  toast.message = "The post has been deleted successfully!";
  toast.type = "error";
};
...
const message = ref(props.flash.success || toast.message);
const type = ref(props.flash.success ? "success" : toast.type);
