...
<template>
  <Head title="Posts" />
  <div class="container mx-auto p-5 w-full flex justify-between items-center relative">
    <h1 class="text-3xl font-bold pb-5 absolute left-1/2 transform -translate-x-1/2">
      Posts
    </h1>
    <Link
  ...
  <div class="mx-auto p-5 grid grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-3">
    <div
